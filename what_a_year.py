...
os.system(f"gsettings set org.gnome.desktop.background picture-uri-dark {os.getcwd()}/current_year.png")
os.system(f"gsettings set org.gnome.desktop.background picture-uri {os.getcwd()}/current_year.png")